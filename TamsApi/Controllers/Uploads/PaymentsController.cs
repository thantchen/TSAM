...
namespace TamsApi.Controllers.Uploads
{
    ...
    {
        private readonly IExcelImporter<Payment> _importer;
        private readonly IAuthenticatedUserBuilder _builder;

        public PaymentsController(IExcelImporter<Payment> importer, IAuthenticatedUserBuilder builder) : base(builder)
        {
