  ...
  <div class="vx-navbar-wrapper navbar-full p-0">
    <vs-navbar class="navbar-custom navbar-skelton" :class="navbarClasses"  :style="navbarStyle" :color="navbarColor">
      ...
      <router-link tag="div" to="/" class="vx-logo cursor-pointer mx-auto flex items-center">
        ...
        <!--span class="vx-logo-text text-primary"><span>TSA</span><div style='font-size: 10px; margin-top: -10px; color: #6D6E70'><i>powered by _</i></div></span-->
        <span class="vx-logo-text text-primary"><span>TSA<span style='font-size: 10px; margin-top: -10px; color: #1d75bc'><i> powered by _</i></span></span><div style='font-size: 10px; margin-top: -10px; color: #6D6E70'>Transition Service Agreement Management Solution</div></span>
        <!--div class="vx-logo-text text-primary">TSA Management Solution</div-->
      </router-link>
<!--
      <i18n />
