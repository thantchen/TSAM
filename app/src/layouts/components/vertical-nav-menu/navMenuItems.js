...
export default [
  ...
  // },
  {
    url: "/apps/tsa/views/tsa-schedule",
    name: "TSA Schedule",
    slug: "tsa-schedule",
    icon: "CalendarIcon",
  },
  {
    url: '/apps/tsa/views/payment-approval',
    name: "Payment Approval",
    slug: "payment-approval",
    icon: "DollarSignIcon",
  },
  {
    url: "/apps/tsa/reports/insights",
    name: "Insights",
    slug: "insights",
    icon: "BookIcon",
  },
  {
    header: "Add/Change/Dispute Request",
    //header: "Actions",
    //url: '/apps/tsa/variable-inputs/change-log',
    //icon: "CommandIcon",
    ...
    items: [
      {
        url: '/apps/tsa/variable-inputs/add-log',
        name: "Add New",
        slug: "add-log",
        icon: "FilePlusIcon",
      },
      {
        url: '/apps/tsa/variable-inputs/change-log',
        name: "Change a TSA or Sub-TSA",
        slug: "change-log",
        icon: "EditIcon",
      },
      {
        url: '/apps/tsa/variable-inputs/dispute-log',
        name: "Dispute an Invoice",
        slug: "dispute-log",
        icon: "ThumbsDownIcon",
      },
      {
        url: '/apps/tsa/variable-inputs/escalation-log',
        name: "Request Performance Standard Escalation",
        slug: "escalation-log",
        icon: "TrendingUpIcon",
      },
    ]
  },
  {
    ...
    items: [
      {
        url: '/apps/tsa/inputs/change-log',
        name: "Change Resolution Log",
        slug: "change-log",
        icon: "Edit3Icon",
      },
      {
        url: '/apps/tsa/inputs/invoices',
        name: "Invoices",
        slug: "invoices",
        icon: "FileTextIcon",
      },
      {
        url: '/apps/tsa/inputs/payments',
        name: "Payments",
        slug: "payments",
        icon: "ZapIcon",
      },
      // {
      //   url: '/apps/tsa/inputs/sell-side-notification-changes',
      //   name: "Sell Side Notification Changes",
      //   slug: "sell-side-notifiction-changes",
      //   icon: "UploadIcon",
      // },
      // {
      //   url: '/apps/tsa/inputs/sell-side-notification-disputes',
      //   name: "Sell Side Notification Disputes",
      //   slug: "sell-side-notification-disputes",
      //   icon: "UploadIcon",
      // },
      {
        url: '/apps/tsa/inputs/tsa-schedule',
        name: "TSA Schedule",
        icon: "UploadIcon",
        slug: "tsa-schedules",
      },
  ...
  },
  {
    ...
    items: [
      {
        url: '/apps/tsa/settings/user-management',
  ...
  /*
  {
    ...
    items: [
      {
        url: "/apps/tsa/outputs/generate-data",
        name: "Generate Data",
        slug: "generate-data",
        icon: "SettingsIcon",
      },
  ...
  },
   {
    header: "Insights",
    icon: "BookIcon",
    url: '/apps/tsa/reports/executive-summary',
    items: [
      {
        url: '/apps/tsa/reports/executive-summary',
      ...
      {
        url: '/apps/tsa/reports/primary-owner',
        name: "Primary Owner",
        icon: "FileIcon",
        slug: "primary-owner",
      },
      {
        url: '/apps/tsa/reports/seller-notification',
        name: "Seller Notification",
        icon: "FileIcon",
        slug: "seller-notification",
      },
      {
        url: '/apps/tsa/reports/individual-tsa-reconciliation',
        name: "Individual TSA Reconciliation",
        icon: "FileIcon",
        slug: "individual-tsa-reconciliation",
      },

      {
        url: '/apps/tsa/reports/payment-approval',
        name: "Payment Approval",
        icon: "FileIcon",
        slug: "payment-approval",
      },
      {
        url: '/apps/tsa/reports/adhoc',
        name: "Ad Hoc",
        icon: "FileIcon",
        slug: "adhoc",
      },
