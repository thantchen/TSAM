    ...
    <div id="change-log">
        <div class="vx-row" style="margin-top: 10px">
            <div class="vx-col w-full">
                <vx-card title="Change a TSA or Sub-TSA">
                    <div class="add_button"><vs-button color="primary" type="border" size="small" style="margin-bottom: 10px; margin-left: -10px" icon="add_box" @click="openRequestLogDialog">Submit TSA Change or Sub-TSA Change</vs-button></div>     
...
export default{
    ...
    methods:{
        ...
        async loadLogs() {
            this.data = await this.httpGet(`/api/input/change-log`);
        },
    ...
    computed: {
        dialogTitle: function() {
            return "TSA Change Request" + (this.isNewSubmission ? " Form" : " - " + this.selectedLogType);
        },
        validate: function() {
    ...
    async mounted() {
        ...
        this.logTypeOptions = logTypes.filter(function(item) {
            return item.name.toLowerCase() == "cancellation" || item.name.toLowerCase() == "modification";
        })
