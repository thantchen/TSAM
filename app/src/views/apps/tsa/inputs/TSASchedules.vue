...
export default{
    ...
    data: function() {
        return {
            ...
            dialogVisible: false,
            data: {},            
            uploadUrl: `${process.env.VUE_APP_SERVICE_API_URL}/api/upload/tsa-schedules`,
    ...
    created() {
        let serviceUri = `${process.env.VUE_APP_SERVICE_API_URL}/api/file-repository/file-type/5`;
