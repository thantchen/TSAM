...
<template>
    <div id="sell-side-notification-changes">
        <div class="vx-row">
...
export default{
    ...
    data: function() {
        return {
            ...
            dialogVisible: false,            
            data: {},       
            uploadUrl: `${process.env.VUE_APP_SERVICE_API_URL}/api/upload/sell-side-notification-changes`,
    ...
    created() {
        let serviceUri = `${process.env.VUE_APP_SERVICE_API_URL}/api/file-repository/file-type/8`;
